...
export function SetupForm() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      const result = await createInitialAdmin(values);
      if (result.success) {
      ...
      toast.error("Failed to create the admin account");
    } finally {
  ...
  return (
    <Card className="border-border/70 bg-background/90 shadow-xl shadow-slate-200/40">
      <CardHeader>
        ...
        <CardDescription>
          This account owns the dashboard for the self-hosted deployment.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
